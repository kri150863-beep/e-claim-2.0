...
interface CarRentalPaymentColumnProp {
    id: string
...
const getCarRentalParams = (vat: number, numberFormat: (val: number) => string, dateFormat: (value: string)=> string) => {
    ...
    const columnProps: CarRentalPaymentColumnProp[] = [
        { id: "createdAt", label: "Date received", sortable: true, dataFormat: dateFormat},
        { id: "invoiceId", label: "Invoice number", searchable: true },
        { id: "make", label: "Make" },
        { id: "model", label: "Model" },
        { id: "registrationId", label: "Registration number" },
        { id: "status", label: "Status", filterable: true },
        { id: "rentals", label: "Amount (MUR)", searchable: true, dataFormat: getAmount },
    ...
    const paymentTitle = "Rental"
    const currency = "MUR"
    const listTitle = "Rental list"
